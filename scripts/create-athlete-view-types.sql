...
-- Add RLS policies for athlete_view_types
ALTER TABLE athlete_view_types ENABLE ROW LEVEL SECURITY;

-- Allow authenticated users to read view types from their org
...
-- Allow admins to manage view types
...
-- Add comments
COMMENT ON TABLE athlete_view_types IS 'Defines different athlete view types/categories for customized experiences';
COMMENT ON COLUMN athletes.view_type_id IS 'References the athlete view type category';
