    ...
    <div className="p-6">
        ...
        <div className="mb-4 flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-10 pr-10 py-2 bg-[#1a1a1a] text-white border border-white/20 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#C9A857] w-full"
            />
            {exerciseSearch && (
              <button
      ...
      {maxes.length === 0 ? (
        ...
        const filteredMaxes = maxes.filter(max => {
          ...
          const metricLabel = getMetricLabel(max.metric_id, max.reps_at_max);
          const metricMatch = metricSearch === '' ||
            metricLabel.toLowerCase().includes(metricSearch.toLowerCase()) ||
            max.metric_id.toLowerCase().includes(metricSearch.toLowerCase());

          return exerciseMatch && metricMatch;
        });
